...
Validated: ONS published 2026 Q2 GDP on 13 August 2026, real GDP grew 0.4000%. Forecast error: 0.0440 percentage points (absolute), smaller than the Q1 2026 error of 0.1560. See `2026-q2-validation.md` for the full comparison against the model's usual error range in this regime.
