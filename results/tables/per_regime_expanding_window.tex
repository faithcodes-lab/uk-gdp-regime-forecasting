\begin{table}
\caption{Per-regime forecast accuracy (expanding-window CV). Lower values indicate better performance for RMSE, MAE, and MASE; higher R2 indicates better fit. Asterisk marks small-sample regimes.}
