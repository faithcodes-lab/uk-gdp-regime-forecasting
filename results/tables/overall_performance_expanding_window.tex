\begin{table}
\caption{Overall forecast accuracy (expanding-window CV). Lower values indicate better performance for RMSE, MAE, and MASE; higher R2 indicates better fit. Mean across folds with standard deviation in parentheses.}
\begin{tabular}{lrrrr}
\toprule
